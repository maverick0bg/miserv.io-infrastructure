...
resource "aws_iam_role_policy_attachment" "amazon_role_AmazonEKSClusterPolicy" {
...
resource "aws_iam_role_policy_attachment" "amazon_role_AmazonEKSVPCResourceController" {
  policy_arn = "arn:aws:iam::aws:policy/AmazonEKSVPCResourceController"
  role       = aws_iam_role.amazon_role.name
}

resource "aws_iam_role_policy_attachment" "amazon_role_AmazonEKSWorkerNodePolicy" {
  policy_arn = "arn:aws:iam::aws:policy/AmazonEKSWorkerNodePolicy"
  role       = aws_iam_role.amazon_role.name
}

resource "aws_iam_role_policy_attachment" "amazon_role_AmazonEKS_CNI_Policy" {
  policy_arn = "arn:aws:iam::aws:policy/AmazonEKS_CNI_Policy"
  role       = aws_iam_role.amazon_role.name
}

resource "aws_iam_role_policy_attachment" "amazon_role_AmazonEC2ContainerRegistryReadOnly" {
  policy_arn = "arn:aws:iam::aws:policy/AmazonEC2ContainerRegistryReadOnly"
  role       = aws_iam_role.amazon_role.name
}

resource "aws_iam_role_policy_attachment" "amazon_role_AmazonEKSFargatePodExecutionRolePolicy" {
...
resource "aws_iam_role_policy_attachment" "atachment_AmazonEKS_EBS_CSI_DriverRole" {
